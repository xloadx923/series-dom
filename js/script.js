...
function displaySeriesById(arrayId){
    document.querySelectorAll("#container > li").forEach(li =>{
        if(arrayId.includes(parseInt(li.dataset.id))) li.classList.remove('hidden');
...
// 14/ Modifier la fonction ci-dessus pour retourner toutes les infos de la série cliquée dans la console.
...
// 19/ Créez une fonction qui fasse qu'au clic sur un favori il se retire de la liste.
function removeFavClick(){
